...
def choose_image(data_dir2, center, left, right, steering_angle):
    """
...
#    mask[(ym - y1) * (x2 - x1) - (y2 - y1) * (xm - x1) <= 0] = 0
...
def augument(data_dir2, center, left, right, steering_angle, range_x=100, range_y=10):
    """
    Generate an augumented image and adjust steering angle.
    (The steering angle is associated with the center image)
    """
    image, steering_angle = choose_image(data_dir2, center, left, right, steering_angle)
...
def batch_generator(data_dir2, image_paths, steering_angles, batch_size, is_training):
    """
